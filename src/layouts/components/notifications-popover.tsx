    ...
    <>
      ...
      >
        <Badge badgeContent={totalUnRead} color="error">
          <SvgColor width={24} src="/assets/icons/bell.svg" />
        </Badge>
      </IconButton>
...
function renderContent(notification: NotificationItemProps) {
    ...
    return {
      avatarUrl: (
        <img
          ...
          src="/assets/icons/notification/ic-notification-package.png"
        />
      ),
      title,
    };
  ...
  if (notification.type === 'order-shipped') {
    return {
      avatarUrl: (
        <img
          alt={notification.title}
          src="/assets/icons/notification/ic-notification-shipping.png"
        />
      ),
      title,
    };
  ...
  if (notification.type === 'mail') {
    return {
      avatarUrl: (
        <img alt={notification.title} src="/assets/icons/notification/ic-notification-mail.png" />
      ),
      title,
    };
  }
  if (notification.type === 'chat-message') {
    return {
      avatarUrl: (
        <img alt={notification.title} src="/assets/icons/notification/ic-notification-chat.png" />
      ),
      title,
    };
  }
