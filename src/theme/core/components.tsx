...
const MuiRating: Components<Theme>['MuiRating'] = {
  defaultProps: {
    icon: <Iconify icon="iconoir:star-solid" sx={{ height: '16px', width: '16px' }} />,
    emptyIcon: <Iconify icon="iconoir:star" sx={{ height: '16px', width: '16px' }} />,
  },
};
      ...
      variants: [
        {
          ...
          style: {
            backgroundColor: varAlpha(theme.palette.primary.lighterChannel, 0.5),
        ...
        },
        {
          ...
          style: {
            backgroundColor: varAlpha(theme.palette.secondary.lighterChannel, 0.5),
        ...
        },
        {
          ...
          style: {
            backgroundColor: varAlpha(theme.palette.info.lighterChannel, 0.5),
        ...
        },
        {
          ...
          style: {
            backgroundColor: varAlpha(theme.palette.success.lighterChannel, 0.5),
        ...
        },
        {
          ...
          style: {
            backgroundColor: varAlpha(theme.palette.warning.lighterChannel, 0.5),
        ...
        },
        {
          ...
          style: {
            backgroundColor: varAlpha(theme.palette.error.lightChannel, 0.25),
